            ...
            <div class="card my-3">
              ...
              <div class="card-body">
                ...
                @foreach(collect($question->answers)->shuffle() as $answers)
                  ...
                  <li> 
                    <input type="radio" radiogroup="answer_question_{{ $question->id }}" name="answer_question_{{ $question->id  }}" id="answer_question_{{ $question->id  }}"> 
                    <label for="answer_question_{{ $question->id  }}">{{ $answers->answer_text }} - {{ $answers->is_correct }}</label>
                  </li>
