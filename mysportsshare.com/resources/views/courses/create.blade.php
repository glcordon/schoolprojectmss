...
<div class="container" style="padding:50px 0px; min-height:70vh">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li><a class="nav-link disabled" id="quiz-tab" data-toggle="tab" href="#quiz" role="tab" aria-controls="quiz" aria-selected="false">Quiz <small><em>(coming soon)</em></small> </a></li>
    </ul>
