...
<!-- HERO -->
<div class="pt-5 mb-5 home-hero" style="background-image:linear-gradient(transparent, black 98%), url({{ Session::get('tenant') == 'home' ? setting('site.main cover') : Storage::url(Session::get('tenant')->site_cover) ?? '' }}); background-size:cover; background-repeat:no-repeat; background-position:50%;">
