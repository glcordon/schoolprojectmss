...
<!-- HERO -->
<div class="pt-5 mb-5 home-hero" style="background-image:linear-gradient(transparent, black 98%), url({{ Session::get('tenant') == 'home' ? Voyager::image(setting('site.main_cover')) : Storage::url(Session::get('tenant')->site_cover) ?? ssetting('site.main_cover')}}); background-size:cover; background-repeat:no-repeat; background-position:50%;">
