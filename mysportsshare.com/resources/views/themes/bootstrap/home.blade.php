...
<!-- HERO -->
<div class="pt-5 mb-5 home-hero" style="background-image:linear-gradient(transparent, white 85%), url({{ Storage::url(Session::get('tenant')->site_cover) ?? '' }}); background-size:contain; background-repeat:no-repeat; background-position:50%;">
	<div class="container">
...
<div id="features" style="background-color:black; padding:4rem 0">
	<div class="container">
