...
<!-- HERO -->
<div class="pt-5 mb-5 home-hero" style="background-image:linear-gradient(transparent, black 98%), url({{ Session::get('tenant') == 'home' ? '' : Storage::url(Session::get('tenant')->site_cover) ?? setting('site.main cover') }}); background-size:cover; background-repeat:no-repeat; background-position:50%;">
