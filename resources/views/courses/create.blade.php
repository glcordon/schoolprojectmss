...
<div class="container" style="padding:50px 0px">
    ...
    <form method="POST" action="/create-course" accept-charset="UTF-8" enctype="multipart/form-data" class="ajax gf">
                    ...
                    <div class="d-flex justify-content-between">
                         <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse${count}" aria-expanded="true" aria-controls="collapse${count}">
                          ...
                          <div id="collapse${count}" class="collapse show" aria-labelledby="headingOne">
                            ...
                            <input type="file" id="video_upload" placeholder="Course Video" value="" name="course_video_upload[]" class="my-2 col-12">
                            <input type="text" placeholder="Course Video" value="" name="course_video[]" class="form-control my-2 col-12">
