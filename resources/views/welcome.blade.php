                                ...
                                <a href="/category/{{$category->id}}" style="position:relative;">
                                    <div class="card bg-dark text-white"  style="text-align:left;max-width: 22rem; min-width:18rem; margin-bottom:20px;">
                                        ...
                                        <div class="card-img-overlay">
                                            <h5 class="card-title" style="width:100%; height:100%; background-color:rgba(0,0,0,0.5); position:absolute; top:0; left:0;">
                                              <span style="position:absolute; top:50%; width:100%; text-align:center"></span>  {{$category->category_name }}
                                            </h5>
                                            <p class="card-text"></p>
                                        </div>
                                    </div>
